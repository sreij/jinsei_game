...
public class GameNightEvent extends Event {
    ...
    private void initializePanels() {
        ...
        JLabel description = new JLabel("<html><center>友人が最新のゲームを買ったらしい。『徹夜でやろうぜ！』と誘われた。<br>参加しますか？</center></html>");
    ...
    private void handleChoice(boolean accepted) {
        ...
        if (accepted) {
            ...
            if (roll == 1) { // 成功
                ...
                resultMessage = "<html><center>楽しかったが、翌日の大事な授業で寝てしまい、<br>評価が下がってしまった... 2単位失う。</center></html>";
                currentPlayer.addCredit(-2);
            }
        } else {
            resultMessage = "<html><center>誘いを断ってしっかり休んだ。<br>体調は万全だ。</center></html>";
        }
